...
@section('adminTitle','Edit Company')
        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Company's</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.companyUpdate')}}" method="post" id="step-form-horizontal" class="step-form-horizontal">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 mb-2">
                                            <div class="form-group">
                                                <label class="text-label"><strong style="color: red;">*</strong><b>Company Name :</b></label>
                                                <input type="text" name="company_name" value="{{$companys->company_name}}" class="form-control" placeholder="Company Name">
                                            </div>
                                        </div>
