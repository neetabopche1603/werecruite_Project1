    ...
    <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" value="{{$profiles->email}}" class="form-control input-default " placeholder="Enter Email" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control input-default" name="address" placeholder="Type your message...">{{$profiles->address}}</textarea>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-xl-5 col-lg-5">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form class="forms-sample mt-4" action="{{route('client.changePassword')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">
